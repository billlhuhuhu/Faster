...
def build_parser():
    ...
    parser.add_argument("--histogram_whitening_pca_dim", type=int, default=256)
    parser.add_argument("--pca_whitening_eps", type=float, default=1e-3)
    parser.add_argument("--chi2_sample_steps", type=int, default=2)
