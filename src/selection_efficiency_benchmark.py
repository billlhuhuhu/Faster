...
def infer_variant_name(args):
    ...
    if getattr(args, "keep_lsrc", True) or getattr(args, "enable_lsrc", False):
        parts.append("lsrc")
    return "_".join(parts)
...
def build_cross_args(args):
    return SimpleNamespace(
        ...
        correction_score_mode=args.correction_score_mode,
        collapse_score_mode=args.collapse_score_mode,
        collapse_score_weight_edge=args.collapse_score_weight_edge,
        collapse_score_weight_a2b=args.collapse_score_weight_a2b,
        collapse_score_weight_b2a=args.collapse_score_weight_b2a,
        collapse_score_weight_nbr2nbr=args.collapse_score_weight_nbr2nbr,
        collapse_neighbor_topk=args.collapse_neighbor_topk,
        tau_g=args.tau_g,
        ...
        fusion_domain_mode=args.fusion_domain_mode,
        fusion_mode=args.fusion_mode,
        lambda_f=args.lambda_f,
        mu_f=args.mu_f,
        fusion_eps=args.fusion_eps,
        wavelet_fusion_scales=args.wavelet_fusion_scales,
        wavelet_fusion_impl=args.wavelet_fusion_impl,
        wavelet_fusion_probe_mode=args.wavelet_fusion_probe_mode,
        wavelet_fusion_probe_dim=args.wavelet_fusion_probe_dim,
        wavelet_fusion_weight_mode=args.wavelet_fusion_weight_mode,
        wavelet_fusion_weight_a_scales=args.wavelet_fusion_weight_a_scales,
        wavelet_fusion_weight_b_scales=args.wavelet_fusion_weight_b_scales,
        wavelet_latent_lambda_sparse=args.wavelet_latent_lambda_sparse,
        wavelet_latent_lambda_sym=args.wavelet_latent_lambda_sym,
        wavelet_latent_lambda_nonneg=args.wavelet_latent_lambda_nonneg,
        wavelet_latent_reconstruction_mode=args.wavelet_latent_reconstruction_mode,
        wavelet_latent_postprocess_topk=args.wavelet_latent_postprocess_topk,
        wavelet_latent_postprocess_threshold=args.wavelet_latent_postprocess_threshold,
...
def build_selection_args(args):
    return SimpleNamespace(
        ...
        wavelet_main_scale_weights=args.wavelet_main_scale_weights,
        wavelet_main_swd_num_projections=args.wavelet_main_swd_num_projections,
        wavelet_cov_weight=args.wavelet_cov_weight,
        wavelet_edge_weight=args.wavelet_edge_weight,
        wavelet_curriculum_schedule=args.wavelet_curriculum_schedule,
        ...
        matching_wavelet_weight=args.matching_wavelet_weight,
...
def build_summary(args, phase_metrics, cross_outputs, selection_outputs, retrieval_metrics=None, retrieval_metrics_path=None):
    ...
    summary = {
        ...
        "correction_score_mode": args.correction_score_mode,
        "collapse_score_mode": args.collapse_score_mode,
        "collapse_neighbor_topk": int(args.collapse_neighbor_topk),
        "collapse_score_weight_edge": float(args.collapse_score_weight_edge),
        "collapse_score_weight_a2b": float(args.collapse_score_weight_a2b),
        "collapse_score_weight_b2a": float(args.collapse_score_weight_b2a),
        "collapse_score_weight_nbr2nbr": float(args.collapse_score_weight_nbr2nbr),
        "fusion_mode": args.fusion_mode,
        "fusion_domain_mode": args.fusion_domain_mode,
        "wavelet_fusion_scales": args.wavelet_fusion_scales,
        "wavelet_fusion_impl": args.wavelet_fusion_impl,
        "wavelet_fusion_probe_mode": args.wavelet_fusion_probe_mode,
        "wavelet_fusion_probe_dim": int(args.wavelet_fusion_probe_dim),
        "wavelet_fusion_weight_mode": args.wavelet_fusion_weight_mode,
        "wavelet_latent_lambda_sparse": float(args.wavelet_latent_lambda_sparse),
        "wavelet_latent_lambda_sym": float(args.wavelet_latent_lambda_sym),
        "wavelet_latent_lambda_nonneg": float(args.wavelet_latent_lambda_nonneg),
        "wavelet_latent_reconstruction_mode": args.wavelet_latent_reconstruction_mode,
        "wavelet_latent_postprocess_topk": None if args.wavelet_latent_postprocess_topk is None else int(args.wavelet_latent_postprocess_topk),
        "wavelet_latent_postprocess_threshold": float(args.wavelet_latent_postprocess_threshold),
        "lambda_main": float(args.lambda_main),
        "wavelet_main_scales": args.wavelet_main_scales,
        "wavelet_main_scale_weights": args.wavelet_main_scale_weights,
        "wavelet_main_swd_num_projections": None if args.wavelet_main_swd_num_projections is None else int(args.wavelet_main_swd_num_projections),
        ...
        "keep_lsrc": bool(args.keep_lsrc),
        "matching_wavelet_weight": float(args.matching_wavelet_weight),
